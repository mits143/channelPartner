...
class ChangePwdPresenter : ChangePasswordView.MainPresenter {

    var context: Context? = null
    var mainView: ChangePasswordView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: ChangePasswordView.MainView?) {
