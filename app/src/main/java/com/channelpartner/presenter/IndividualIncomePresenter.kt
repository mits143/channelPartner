...
class IndividualIncomePresenter : IndividualInccomeView.MainPresenter {

    var context: Context? = null
    var mainView: IndividualInccomeView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: IndividualInccomeView.MainView?) {
