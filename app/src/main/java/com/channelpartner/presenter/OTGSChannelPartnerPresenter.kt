...
class OTGSChannelPartnerPresenter : OTGSChannelPartnerView.MainPresenter {

    var context: Context? = null
    var mainView: OTGSChannelPartnerView.MainView? = null

    @NonNull
    var disposable: Disposable? = null

    constructor(context: Context?, mainView: OTGSChannelPartnerView.MainView?) {
