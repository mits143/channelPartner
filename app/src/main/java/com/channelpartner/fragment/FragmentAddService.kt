...
class FragmentAddService : Fragment(), RenewalView.MainView {

    var addservicepresenter: AddServicePresenter? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        addservicepresenter = AddServicePresenter(context, this)
    ...
    override fun onSuccess(responseModel: Response<PackageRerquestResponse>) {
        if (responseModel.body() != null) {
            if (responseModel.body()!!.cp.size > 0) {
