...
class FragmentExperts : Fragment(), SubscripitionView.MainView {

    var presenter: SubscriptionPresenter? = null
    var adapter: SubscriptionExpertAdapter? = null
    var dataList: ArrayList<CareerExpert>? = arrayListOf()
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = SubscriptionExpertAdapter(
            context!!,
            dataList!!,
    ...
    override fun onSuccess(responseModel: Response<SubscrpitionResponse>) {
        if (responseModel.body() != null && responseModel.body()!!.classes.isNotEmpty()) {
            dataList!!.clear()
            dataList!!.addAll(responseModel.body()!!.career_experts)
