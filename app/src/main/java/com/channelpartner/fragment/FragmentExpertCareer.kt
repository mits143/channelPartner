...
import com.channelpartner.presenter.FragmentExpertCareerPresenter
...
class FragmentExpertCareer : Fragment(), OTGSSPNetworkView.MainView, SearchView.OnQueryTextListener  {

    var fragmentexpertcareerpresenter: FragmentExpertCareerPresenter? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentexpertcareerpresenter = FragmentExpertCareerPresenter(context, this)
...
//        fragmentexpertcareerpresenter!!.loadDirectData(
...
//            level_id
//        )
//        fragmentexpertcareerpresenter!!.loadIndirectData(
//            sessionManager.getAuthToken(context)!!,
//            page!!,
//            sessionManager.getUser_ID(context)!!,
//            sessionManager.getUser_ID(context)!!.toInt(),
    ...
    private fun onClick(cpDetail: CpDetail) {
        context!!.startActivity(
            Intent(context!!, DetailActivity::class.java).putExtra(
                ...
                .putExtra("class_name", "FragmentExpertCareer")
        )
    }
...
//                txtInDirect.text = "InDirect: " + responseModel.body()!!.total_count
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        fragmentexpertcareerpresenter!!.onStop()
    }
}
