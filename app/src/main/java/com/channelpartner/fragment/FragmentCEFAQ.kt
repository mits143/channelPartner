...
class FragmentCEFAQ : Fragment(), FAQView.MainView {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter!!.loadData(sessionManager.getAuthToken(context)!!)
        ...
        if (responseModel.body() != null) {
            if (responseModel.body()!!.size > 0) {
                ...
                for (i in responseModel.body()!!.indices) {
                    if (TextUtils.equals(responseModel.body()!![i].type, "CareerExpert")) {
