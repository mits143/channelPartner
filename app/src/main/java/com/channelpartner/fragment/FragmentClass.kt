...
import com.channelpartner.presenter.FragmentClassPresenter
...
class FragmentClass : Fragment(), OTGSSPNetworkView.MainView,
    SearchView.OnQueryTextListener {

    var fragmentclasspresenter: FragmentClassPresenter? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentclasspresenter = FragmentClassPresenter(context, this)
...
//        fragmentclasspresenter!!.loadDirectData(
...
//            level_id
//        )
//        fragmentclasspresenter!!.loadIndirectData(
//            sessionManager.getAuthToken(context)!!,
//            page!!,
//            sessionManager.getUser_ID(context)!!,
//            sessionManager.getUser_ID(context)!!.toInt(),
    ...
    private fun onClick(cpDetail: CpDetail) {
        context!!.startActivity(
            Intent(context!!, DetailActivity::class.java)
                ...
                .putExtra("class_name", "FragmentClass")
        )
    }
