...
import com.channelpartner.adapter.SubscriptionCoursestAdapter
...
class FragmentCourses : Fragment(), SubscripitionView.MainView {

    var presenter: SubscriptionPresenter? = null
    var adapter: SubscriptionCoursestAdapter? = null
    var dataList: ArrayList<Course>? = arrayListOf()
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter = SubscriptionCoursestAdapter(
            context!!,
            dataList!!,
    ...
    override fun onSuccess(responseModel: Response<SubscrpitionResponse>) {
        if (responseModel.body() != null && responseModel.body()!!.classes.isNotEmpty()) {
            dataList!!.clear()
            dataList!!.addAll(responseModel.body()!!.courses)
