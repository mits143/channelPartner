...
import com.channelpartner.presenter.FragmentTeacherPresenter
...
class FragmentTeacher : Fragment(), OTGSSPNetworkView.MainView,
    SearchView.OnQueryTextListener {

    var fragmentteacherpresenter: FragmentTeacherPresenter? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentteacherpresenter = FragmentTeacherPresenter(context, this)
        ...
        otgschannelpartnerDirectadapter = OTGSChannelPartnerAdapter(context!!, cpdetailDirectList!!,
        ...
        otgschannelpartnerIndirectadapter =
            OTGSChannelPartnerAdapter(context!!, cpdetailInDirectList!!,
                { cpdetailList -> onClick(cpdetailList) })

        recyclerView1!!.adapter = otgschannelpartnerIndirectadapter

//        fragmentteacherpresenter!!.loadDirectData(
...
//            level_id
//        )
//        fragmentteacherpresenter!!.loadIndirectData(
//            sessionManager.getAuthToken(context)!!,
//            page!!,
//            sessionManager.getUser_ID(context)!!,
//            sessionManager.getUser_ID(context)!!.toInt(),
    ...
    private fun onClick(cpDetail: CpDetail) {
        context!!.startActivity(
            Intent(context!!, DetailActivity::class.java).putExtra(
                ...
                .putExtra("class_name", "FragmentTeacher")
        )
    }
...
//                txtInDirect.text = "InDirect: " + responseModel.body()!!.total_count
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        fragmentteacherpresenter!!.onStop()
    }
}
