...
import com.channelpartner.model.response.Teacher


class SubscriptionTeacherAdapter(
    internal var context: Context,
    val dataList: ArrayList<Teacher>,
    val clickListener: (Teacher) -> Unit
) :
    RecyclerView.Adapter<SubscriptionTeacherAdapter.ViewHolder>() {

    //this method is returning the view for each item in the list
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SubscriptionTeacherAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.cell_subscription, parent, false)
        return ViewHolder(v)
    }

    //this method is binding the data on the list
    override fun onBindViewHolder(holder: SubscriptionTeacherAdapter.ViewHolder, position: Int) {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(data: Teacher, clickListener: (Teacher) -> Unit) {
